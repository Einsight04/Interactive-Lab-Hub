...
These are new review drafts based on the classmates' public Lab 2 pages, read on September 19, 2026. They have **not been sent**, and no replies are claimed. These are the same peer contacts identified in Lab 1; their current Lab 2 teams may differ.
...
## Feedback on One More Window

No received feedback has been verified. Ask each peer to try the sketch or prototype and record their actual response to: What do the windows mean? Can you tell paused from finished? Would you expect the break to start automatically?

## Design critique used during implementation (AI, not peer feedback)

- A dark building needs a completion label so it does not look broken.
