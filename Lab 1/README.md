...
- Elliot Waxman: built Pocket Blinkenlights, the grid page, the text and Pong server, the Twilio setup, and the Fly.io deployment
- Ghaith Khalil: research on the original piece, the storyboards, and this report
- Both of us: planning the interaction, recording the videos, and giving and collecting feedback with the other groups
